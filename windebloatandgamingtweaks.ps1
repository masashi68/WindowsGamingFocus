...
$tweaks = @(
	...
	### comment by masashi68 ### "InstallEverything", ### added by masashi68 ###
	### comment by masashi68 ### "Install7Zip",
	### comment by masashi68 ### "InstallChocoUpdates",
	...
	### comment by masashi68 ### "askDefender",
	...
	### comment by masashi68 ### "EnableLockScreen",				# "DisableLockScreen",
	### comment by masashi68 ### "EnableLockScreenRS1",			# "DisableLockScreenRS1",
	# "HideNetworkFromLockScreen",    # "ShowNetworkOnLockScreen",
	# "HideShutdownFromLockScreen",   # "ShowShutdownOnLockScreen",
	"DisableStickyKeys",            # "EnableStickyKeys",
	### comment by masashi68 ### "ShowTaskManagerDetails"        # "HideTaskManagerDetails",
	"ShowFileOperationsDetails",    # "HideFileOperationsDetails",
	### comment by masashi68 ### "DisableFileDeleteConfirm",	# "EnableFileDeleteConfirm",    
	### comment by masashi68 ### "HideTaskbarSearch",
	#"ShowTaskbarSearchIcon",      # "ShowTaskbarSearchBox",
	"ShowTaskbarSearchBox",### add by masashi68 ###
	### comment by masashi68 ###"HideTaskView",                 # "ShowTaskView",
	# "ShowSmallTaskbarIcons",        # "ShowLargeTaskbarIcons",
	# "SetTaskbarCombineWhenFull",    # "SetTaskbarCombineNever",     # "SetTaskbarCombineAlways",
	"HideTaskbarPeopleIcon",        # "ShowTaskbarPeopleIcon",
	#"HideTrayIcons",                #"ShowTrayIcons",
	### comment by masashi68 ### "DisableSearchAppInStore",      # "EnableSearchAppInStore",
	### comment by masashi68 ### "DisableNewAppPrompt",          # "EnableNewAppPrompt",
	# "SetControlPanelSmallIcons",  # "SetControlPanelLargeIcons",  # "SetControlPanelCategories",
	"SetVisualFXPerformance",     # "SetVisualFXAppearance",
	# "AddENKeyboard",              # "RemoveENKeyboard",
	### comment by masashi68 ### "EnableNumlock",             	# "DisableNumlock",
	### comment by masashi68 ### "EnableDarkMode",				# "DisableDarkMode",
	### Explorer UI Tweaks ###
	### comment by masashi68 ### "ShowKnownExtensions",          # "HideKnownExtensions",
	### comment by masashi68 ### "HideHiddenFiles",
	### comment by masashi68 ### "HideSyncNotifications"         # "ShowSyncNotifications",
	### comment by masashi68 ### "HideRecentShortcuts",          # "ShowRecentShortcuts",
	### comment by masashi68 ### "SetExplorerThisPC",            # "SetExplorerQuickAccess",
	### comment by masashi68 ### "ShowThisPCOnDesktop",          # "HideThisPCFromDesktop",
	### comment by masashi68 ### "ShowUserFolderOnDesktop",    # "HideUserFolderFromDesktop",
	### comment by masashi68 ### "Hide3DObjectsFromThisPC",      # "Show3DObjectsInThisPC",
	### comment by masashi68 ### "Hide3DObjectsFromExplorer",  # "Show3DObjectsInExplorer",
	### comment by masashi68 ### "EnableThumbnails",          # "EnableThumbnails", # "DisableThumbnails",
	### comment by masashi68 ### "EnableThumbsDB",              # "EnableThumbsDB", # "DisableThumbsDB", 
	### Application Tweaks ###
	#"UninstallMediaPlayer",         #"InstallMediaPlayer",
	### comment by masashi68 ### "UninstallInternetExplorer",  # "InstallInternetExplorer",
	### comment by masashi68 ### "UninstallWorkFolders",       # "InstallWorkFolders",
	### comment by masashi68 ### "UninstallLinuxSubsystem",      # "UninstallLinuxSubsystem",     #"InstallLinuxSubsystem",
	# "InstallHyperV",              # "UninstallHyperV",
	### comment by masashi68 ### "SetPhotoViewerAssociation",    # "UnsetPhotoViewerAssociation",
	### comment by masashi68 ### "AddPhotoViewerOpenWith",       # "RemovePhotoViewerOpenWith",
	### comment by masashi68 ### "InstallPDFPrinter",		# "UninstallPDFPrinter",
	### comment by masashi68 ### "SVCHostTweak",
	### Unpinning ###
	### comment by masashi68 ### "UnpinStartMenuTiles",
        ### DaddyMadu Quality Of Life Tweaks ###
	### comment by masashi68 ### "QOL",
...
Function InstallTitusProgs {
	...
	Start-BitsTransfer -Source "https://raw.githubusercontent.com/masashi68/WindowsGamingFocus/master/ooshutup10.cfg" -Destination ooshutup10.cfg
...
Function DISGaming {
	...
	### comment by masashi68 ### Stop-Service "UmRdpService" -WarningAction SilentlyContinue
	### comment by masashi68 ### Set-Service "UmRdpService" -StartupType Disabled
	Stop-Service "TrkWks" -WarningAction SilentlyContinue
	Set-Service "TrkWks" -StartupType Disabled
	### comment by masashi68 ### Stop-Service "TermService" -WarningAction SilentlyContinue
	### comment by masashi68 ### Set-Service "TermService" -StartupType Disabled
...
# Disable Fullscreen Optimizations and related Game DVR features
Function FullscreenOptimizationFIX {
    Write-Output "Disabling Fullscreen Optimization and related Game DVR settings..."

    $errpref = $ErrorActionPreference
    $ErrorActionPreference = "SilentlyContinue"

    # Disable Fullscreen Optimization behavior modes
    ...
    # Disable App capture (Game DVR) for the current user
    Set-ItemProperty -Path "HKCU:\SOFTWARE\Microsoft\Windows\CurrentVersion\GameDVR" -Name "AppCaptureEnabled" -Type DWord -Value 0

    # Enable SwapEffectUpgradeCache for DirectX Graphics Settings
    ...
    # Set maximum inactivity shutdown delay for SoftwareProtectionPlatform service
    ...
    # Set Desktop Window Manager overlay test mode
    Set-ItemProperty -Path "HKLM:\SOFTWARE\Microsoft\Windows\Dwm" -Name "OverlayTestMode" -Type DWord -Value 5

    # Check if SysMain service (related to Memory Compression) is running before disabling memory compression
    $sysMain = Get-Service -Name "SysMain" -ErrorAction SilentlyContinue
    if ($sysMain -and $sysMain.Status -eq 'Running') {
        Disable-MMAgent -MemoryCompression | Out-Null
    } else {
        Write-Output "SysMain service is not running or disabled; skipping Memory Compression disable."
    }
